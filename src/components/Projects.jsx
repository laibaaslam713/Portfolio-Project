  ...
  const CATEGORY_COLOR = {
    AI:  { bg: 'rgba(139,92,246,0.12)', border: 'rgba(139,92,246,0.35)', text: '#c084fc' },
    Web: { bg: 'rgba(255,20,147,0.10)', border: 'rgba(255,156,220,0.35)', text: 'var(--pink-hot)' },
  };

  function ProjectCard({ project }) {
    const cat = CATEGORY_COLOR[project.category] ?? CATEGORY_COLOR.Web;
